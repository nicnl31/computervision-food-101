...
The `food-101` folder in this repo contains the metadata that lists the images in each of the train and test sets. Actual images are not uploaded due to their size. 
